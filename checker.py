...
def get_np_status(track):
    try:
        ...
        # Принудительно используем формат multipart/form-data
        payload = {
            'token': (None, token),
